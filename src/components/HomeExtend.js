...
export const HomeExtend = () => {
  return (
    <div className='pt-10 pb-10 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mx-auto space-x-2 text-center bg-white'>
        <div className='w-72 space-y-2 pb-3 bg-slate-200 rounded-md mx-auto text-center border-1 border-white shadow-md'>
        ...
        <div className='w-72 space-y-2 pb-3 bg-slate-200 rounded-md mx-auto text-center shadow-md'>
